...
public class PaymentServiceImpl implements PaymentService {
    ...
    public CommonResult<Payment> addPayment(int order_identifier) {
        ...
        if(i > 0){
            return new CommonResult<Payment>(200,"添加订单成功,端口为:"+8080,new Payment(i,order_identifier));
        }else{
            return new CommonResult<Payment>(400,"添加订单失败,端口为:"+8080,new Payment(i,order_identifier));
        }
    }
